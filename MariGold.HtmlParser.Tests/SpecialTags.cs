namespace MariGold.HtmlParser.Tests
{
	...
	public class SpecialTags
	{
		...
		public void MetaTag()
		{
			...
			TestUtility.AreEqual(parser.Current.Children[0], "head", "<meta charset=\"utf-8\" />", "<head><meta charset=\"utf-8\" /></head>");
			...
			TestUtility.AreEqual(parser.Current.Children[0].Children[0], "meta", "<meta charset=\"utf-8\" />", "<meta charset=\"utf-8\" />");
		...
		public void LinkSelfAndCloseTag()
		{
			...
			Assert.IsNotNull(parser.Current.Children[0]);
			TestUtility.AreEqual(parser.Current.Children[0], "link", "<link href=\"/favicon.ico\" rel=\"shortcut icon\" type=\"image/x-icon\" />", "<link href=\"/favicon.ico\" rel=\"shortcut icon\" type=\"image/x-icon\" />");
			Assert.IsNotNull(parser.Current.Children[0].Parent);
			Assert.AreEqual(parser.Current, parser.Current.Children[0].Parent);
        ...
        public void DocTypeAndHtmlNodeWithHeadAndTitle()
        {
            ...
            Assert.IsNotNull(parser.Current.Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0], "head", "<title></title>", "<head><title></title></head>");
            Assert.IsNotNull(parser.Current.Children[0].Parent);
            Assert.AreEqual(parser.Current, parser.Current.Children[0].Parent);
            Assert.AreEqual(true, parser.Current.Children[0].HasChildren);
            Assert.AreEqual(1, parser.Current.Children[0].Children.Count);
            ...
            Assert.IsNotNull(parser.Current.Children[0].Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0].Children[0], "title", "", "<title></title>");
            Assert.IsNotNull(parser.Current.Children[0].Children[0].Parent);
            Assert.AreEqual(parser.Current.Children[0], parser.Current.Children[0].Children[0].Parent);
            Assert.AreEqual(false, parser.Current.Children[0].Children[0].HasChildren);
            Assert.AreEqual(0, parser.Current.Children[0].Children[0].Children.Count);
        ...
        public void DocTypeFullHeadWithAttrAndTitleLink()
        {
            ...
            Assert.IsNotNull(parser.Current.Children[0].Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0].Children[0], "link", "<link href=\"http://google.com\" />", "<link href=\"http://google.com\" />");
            Assert.IsNotNull(parser.Current.Children[0].Children[0].Parent);
            Assert.AreEqual(parser.Current.Children[0], parser.Current.Children[0].Children[0].Parent);
            Assert.AreEqual(false, parser.Current.Children[0].Children[0].HasChildren);
            Assert.AreEqual(0, parser.Current.Children[0].Children[0].Children.Count);
