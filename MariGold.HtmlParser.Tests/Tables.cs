namespace MariGold.HtmlParser.Tests
{
    ...
    public class Tables
    {
        ...
        public void SimpleTable()
        {
            ...
            TestUtility.AreEqual(parser.Current.Children[0], "tr", "<td>1</td>", "<tr><td>1</td></tr>");
            Assert.IsNotNull(parser.Current.Children[0].Parent);
            Assert.AreEqual(parser.Current.Children[0].Parent, parser.Current);

            Assert.IsNotNull(parser.Current.Children[0].Children);
            Assert.AreEqual(1, parser.Current.Children[0].Children.Count);
            Assert.IsNotNull(parser.Current.Children[0].Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0].Children[0], "td", "1", "<td>1</td>");
            Assert.IsNotNull(parser.Current.Children[0].Children[0].Parent);
            Assert.AreEqual(parser.Current.Children[0].Children[0].Parent, parser.Current.Children[0]);
        ...
        public void TableWithOneRowAndTwoColumn()
        {
            ...
            Assert.AreEqual(1, parser.Current.Children.Count);
            Assert.IsNotNull(parser.Current.Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0], "tr", "<td>1</td><td></td>", "<tr><td>1</td><td></td></tr>");
            Assert.IsNotNull(parser.Current.Children[0].Parent);
            Assert.AreEqual(parser.Current.Children[0].Parent, parser.Current);
            ...
            TestUtility.AreEqual(parser.Current.Children[0].Children[1], "td", "", "<td></td>");
            Assert.IsNotNull(parser.Current.Children[0].Children[1].Parent);
            Assert.AreEqual(parser.Current.Children[0].Children[1].Parent, parser.Current.Children[0]);
        ...
        public void TwoRowWithOneColumnEach()
        {
            ...
            Assert.IsNotNull(parser.Current.Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0], "tr", "<td>test1</td>", "<tr><td>test1</td></tr>");
            Assert.AreEqual(parser.Current, parser.Current.Children[0].Parent);

            Assert.IsNotNull(parser.Current.Children[0].Children);
            Assert.AreEqual(1, parser.Current.Children[0].Children.Count);
            Assert.IsNotNull(parser.Current.Children[0].Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0].Children[0], "td", "test1", "<td>test1</td>");
            ...
            TestUtility.AreEqual(parser.Current.Children[1], "tr", "<td>test2</td>", "<tr><td>test2</td></tr>");
            Assert.AreEqual(parser.Current, parser.Current.Children[1].Parent);

            Assert.IsNotNull(parser.Current.Children[1].Children);
            Assert.AreEqual(1, parser.Current.Children[1].Children.Count);
            Assert.IsNotNull(parser.Current.Children[1].Children[0]);
            TestUtility.AreEqual(parser.Current.Children[1].Children[0], "td", "test2", "<td>test2</td>");
            Assert.AreEqual(parser.Current.Children[1], parser.Current.Children[1].Children[0].Parent);
        }
        ...
        public void OneCellWithSpanText()
        {
            ...
            Assert.AreEqual(1, parser.Current.Children.Count);
            Assert.IsNotNull(parser.Current.Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0], "tr", "<td><span>s1</span>test</td>",
            ...
            Assert.AreEqual(1, parser.Current.Children[0].Children.Count);
            Assert.IsNotNull(parser.Current.Children[0].Children[0]);
            TestUtility.AreEqual(parser.Current.Children[0].Children[0], "td",
                "<span>s1</span>test",
