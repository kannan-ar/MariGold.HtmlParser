...
{
    [Fact]
    public async Task DivClassAllNextP()
    {
        string html = @"<style>
                                div.cls~p
                                {
    ...
    [Fact]
    public async Task DivClassImmediateP()
    {
        string html = @"<style>
                                div.cls > p
                                {
    ...
    [Fact]
    public async Task DivClassFirstChild()
    {
        string html = @"<style>
                                div.cls:first-child
                                {
    ...
    [Fact]
    public async Task DivClassAttributeFirstChild()
    {
        string html = @"<style>
    ...
    [Fact]
    public async Task CustomAttributeWithValueOnly()
    {
        string html = @"<style>
                                [attr='val']
                                {
    ...
    [Fact]
    public async Task DivGlobalStyle()
    {
        string html = @"<style>
								div *
								{
    ...
    [Fact]
    public async Task IdentityLastChildP()
    {
        string html = @"<style>
								#dv:last-child p
								{
    ...
    [Fact]
    public async Task AttributeImmediateChildrenClass()
    {
        string html = @"<style>
								[attr] > .cls
								{
    ...
    [Fact]
    public async Task PDivWithImmediateChildrenSpan()
    {
        string html = @"<style>
								div > span, p
								{
    ...
    [Fact]
    public async Task StylesFromDivAndSpan()
    {
        string html = @"<style>
								span
								{
    ...
    [Fact]
    public async Task StylesFromDivAndSpanClass()
    {
        string html = @"<style>
								span
								{
    ...
    [Fact]
    public async Task StylesFromDivClassAndSpanClass()
    {
        string html = @"<style>
								span
								{
    ...
    [Fact]
    public async Task StylesFromInlineDivClassAndSpanClass()
    {
        string html = @"<style>
								span
								{
    ...
    [Fact]
    public async Task StylesFromInlineDivClassAndSpanInlineClass()
    {
        string html = @"<style>
								span
								{
    ...
    [Fact]
    public async Task GlobalAndElementSelector()
    {
