namespace MariGold.HtmlParser.Tests
{
    ...
    public class FromFile
    {
        ...
        public void Basic()
        {
            ...
            TestUtility.CheckAttribute(node.Attributes.ElementAt(0), "html", "");
            ...
            TestUtility.CheckAttribute(node.Attributes.ElementAt(0), "lang", "en");
            TestUtility.CheckAttribute(node.Attributes.ElementAt(1), "xmlns", "http://www.w3.org/1999/xhtml");
            ...
            TestUtility.CheckAttribute(node.Children[1].Children[1].Attributes.ElementAt(0), "charset", "utf-8");
        ...
        public void BasicWithAttributes()
        {
            ...
            TestUtility.AnalyzeNode(node.Children[1], "head",
                ...
                "<head id=\"hd\" style=\"margin:2px;\">\r\n    <meta charset=\"utf-8\" name=\"mt\" />\r\n    <title id=\"tt\">this is test</title>\r\n</head>",
                node, false, true, 5, 2);
            TestUtility.CheckAttribute(node.Children[1].Attributes.ElementAt(0), "id", "hd");
            TestUtility.CheckAttribute(node.Children[1].Attributes.ElementAt(1), "style", "margin:2px;");
            ...
            TestUtility.CheckAttribute(node.Children[1].Children[1].Attributes.ElementAt(0), "charset", "utf-8");
            TestUtility.CheckAttribute(node.Children[1].Children[1].Attributes.ElementAt(1), "name", "mt");
            ...
            TestUtility.CheckAttribute(node.Children[1].Children[3].Attributes.ElementAt(0), "id", "tt");
            ...
            TestUtility.AnalyzeNode(node.Children[3], "body", "\r\n\r\n", "<body id=\"bd\" role=\"application\" ng-app>\r\n\r\n</body>",
                node, false, true, 1, 3);
            TestUtility.CheckAttribute(node.Children[3].Attributes.ElementAt(0), "id", "bd");
            TestUtility.CheckAttribute(node.Children[3].Attributes.ElementAt(1), "role", "application");
            TestUtility.CheckAttribute(node.Children[3].Attributes.ElementAt(2), "ng-app", "");
